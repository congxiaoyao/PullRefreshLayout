 ...
 * not be a refresh, it must call setmRefreshing(false) to cancel any visual
 * indication of a refresh. If an activity wishes to show just the progress
 * animation, it should call setmRefreshing(true). To disable the gesture and
